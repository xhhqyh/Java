...
@WebServlet("/QueryBookClassifyServlet")
public class QueryBookClassifyServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(bkclList != null){
			...
			request.getRequestDispatcher("/Admin/leibie_list.jsp").forward(request, response);
		}
